...
const availableCategories = [
  ...
  Categoryy(id: 'c2', title: 'Quick & Easy', color: Colors.red),
  Categoryy(id: 'c3', title: 'Hamburgers', color: Colors.orange),
  Categoryy(id: 'c4', title: 'German', color: Colors.amber),
  Categoryy(id: 'c5', title: 'Light & Lovely', color: Colors.blue),
  Categoryy(id: 'c6', title: 'Exotic', color: Colors.green),
  Categoryy(id: 'c7', title: 'Breakfast', color: Colors.lightBlue),
  Categoryy(id: 'c8', title: 'Asian', color: Colors.lightGreen),
  Categoryy(id: 'c9', title: 'French', color: Colors.pink),
  Categoryy(id: 'c10', title: 'Summer', color: Colors.teal),
];
...
const dummyMeals = [
  Meal(
    ...
    imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Spaghetti_Bolognese_mit_Parmesan_oder_Grana_Padano.jpg/960px-Spaghetti_Bolognese_mit_Parmesan_oder_Grana_Padano.jpg',
    duration: 20,
    ingredients: [
      '4 Tomatoes',
